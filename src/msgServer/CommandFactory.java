...
public class CommandFactory 
{
    ...
    throws IOException
  {
	...
	switch (command) 
	  ...
	  case MsgProtocol.REGISTER: //107
		    return new registerUser(in, out, serverConn);
		    
	  case MsgProtocol.UPDATE_DETAILS: //108
		    return new UpdateRegistration(in, out, serverConn);
		    
	  case MsgProtocol.SET_REMINDER: //109
		    return new SetReminder(in, out, serverConn);
